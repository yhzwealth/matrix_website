...
public class ApiResponse<T> implements Serializable {
    ...
    public ApiResponse(Collection<T> dataList, Long total,Long allTotal) {
        this.reCode = HttpStatusEnum.RE_CODE_SUCCESS.getCode();
        this.reMsg = HttpStatusEnum.RE_CODE_SUCCESS.getMessage();
        body.put(Constant.TOTAL, total);
        body.put(Constant.DATA_LIST, dataList);
        body.put(Constant.ALL_TOTAl,allTotal);
    }

    public ApiResponse(Collection<T> dataList, Long total,Integer allTotal) {
        this.reCode = HttpStatusEnum.RE_CODE_SUCCESS.getCode();
        this.reMsg = HttpStatusEnum.RE_CODE_SUCCESS.getMessage();
        body.put(Constant.TOTAL, total);
        body.put(Constant.DATA_LIST, dataList);
